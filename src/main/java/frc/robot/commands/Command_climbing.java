...
public class Command_climbing extends Command {
  ...
  private final BooleanSupplier desired_Position;
  public Command_climbing(Subsytem_climb subsystem, BooleanSupplier given_Position) {
  ...
  public void initialize() {
    m_climb.goClimb(desired_Position.getAsBoolean());
  }
